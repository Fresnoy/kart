...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field gallery on 'Itinerary'
        m2m_table_name = db.shorten_name(u'production_itinerary_gallery')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('itinerary', models.ForeignKey(orm[u'production.itinerary'], null=False)),
            ('gallery', models.ForeignKey(orm[u'assets.gallery'], null=False))
        ))
        db.create_unique(m2m_table_name, ['itinerary_id', 'gallery_id'])


    def backwards(self, orm):
        # Removing M2M table for field gallery on 'Itinerary'
        db.delete_table(db.shorten_name(u'production_itinerary_gallery'))
