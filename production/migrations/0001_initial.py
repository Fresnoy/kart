# Generated by Django 2.2.6 on 2019-11-07 11:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ManyToManyField(related_name='artworks', to='people.Artist')),
                ('beacons', models.ManyToManyField(blank=True, related_name='artworks', to='common.BTBeacon')),
                ('in_situ_galleries', sortedm2m.fields.SortedManyToManyField(blank=True, help_text=None, related_name='artworks_insitu', to='assets.Gallery')),
                ...
                ('mediation_galleries', sortedm2m.fields.SortedManyToManyField(blank=True, help_text=None, related_name='artworks_mediation', to='assets.Gallery')),
                ('press_galleries', sortedm2m.fields.SortedManyToManyField(blank=True, help_text=None, related_name='artworks_press', to='assets.Gallery')),
                ('process_galleries', sortedm2m.fields.SortedManyToManyField(blank=True, help_text=None, related_name='artworks_process', to='assets.Gallery')),
                ('teaser_galleries', sortedm2m.fields.SortedManyToManyField(blank=True, help_text=None, related_name='artworks_teaser', to='assets.Gallery')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='diffusion.Place')),
                ('subevents', models.ManyToManyField(blank=True, limit_choices_to=production.models.main_event_false_limit, related_name='parent_event', to='production.Event')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genres', models.ManyToManyField(blank=True, to='production.FilmGenre')),
                ('shooting_place', models.ManyToManyField(blank=True, to='diffusion.Place')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
