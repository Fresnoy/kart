...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding SortedM2M table for field press_galleries on 'Artwork'
        db.create_table(u'production_artwork_press_galleries', (
        ...
        db.create_unique(u'production_artwork_press_galleries', ['artwork_id', 'gallery_id'])

        # Adding SortedM2M table for field teaser_galleries on 'Artwork'
        db.create_table(u'production_artwork_teaser_galleries', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('artwork', models.ForeignKey(orm[u'production.artwork'], null=False)),
            ('gallery', models.ForeignKey(orm[u'assets.gallery'], null=False)),
            ('sort_value', models.IntegerField())
        ))
        db.create_unique(u'production_artwork_teaser_galleries', ['artwork_id', 'gallery_id'])

    def backwards(self, orm):
        # Removing M2M table for field press_galleries on 'Artwork'
        db.delete_table(db.shorten_name(u'production_artwork_press_galleries'))

        # Removing M2M table for field teaser_galleries on 'Artwork'
        db.delete_table(db.shorten_name(u'production_artwork_teaser_galleries'))
    ...
    models = {
        ...
        u'production.artwork': {
            ...
            'press_galleries': ('sortedm2m.fields.SortedManyToManyField', [], {'symmetrical': 'False', 'related_name': "'artworks_press'", 'blank': 'True', 'to': u"orm['assets.Gallery']"}),
            ...
            'teaser_galleries': ('sortedm2m.fields.SortedManyToManyField', [], {'symmetrical': 'False', 'related_name': "'artworks_teaser'", 'blank': 'True', 'to': u"orm['assets.Gallery']"}),
