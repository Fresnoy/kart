...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('production_artwork_process_galleries', 'sort_value', models.IntegerField(default=0), keep_default=True)
        db.add_column('production_artwork_in_situ_galleries', 'sort_value', models.IntegerField(default=0), keep_default=True)
        db.add_column('production_artwork_mediation_galleries', 'sort_value', models.IntegerField(default=0), keep_default=True)
