...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Itinerary.updated_on'
        db.add_column(u'production_itinerary', 'updated_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 5, 19, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Production.updated_on'
        db.add_column(u'production_production', 'updated_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 5, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Itinerary.updated_on'
        db.delete_column(u'production_itinerary', 'updated_on')

        # Deleting field 'Production.updated_on'
        db.delete_column(u'production_production', 'updated_on')
