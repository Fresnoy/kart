...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field beacons on 'Artwork'
        m2m_table_name = db.shorten_name(u'production_artwork_beacons')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('artwork', models.ForeignKey(orm[u'production.artwork'], null=False)),
            ('btbeacon', models.ForeignKey(orm[u'common.btbeacon'], null=False))
        ))
        db.create_unique(m2m_table_name, ['artwork_id', 'btbeacon_id'])


    def backwards(self, orm):
        # Removing M2M table for field beacons on 'Artwork'
        db.delete_table(db.shorten_name(u'production_artwork_beacons'))
