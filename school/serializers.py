...
class StudentSerializer(serializers.HyperlinkedModelSerializer):
    ...
    user = serializers.HyperlinkedRelatedField(view_name="user-detail", queryset=User.objects.all(), write_only=True)
...
class StudentApplicationSetupSerializer(serializers.HyperlinkedModelSerializer):
    ...
    applications = serializers.HyperlinkedRelatedField(many=True, read_only=True, view_name="studentapplication-detail")
