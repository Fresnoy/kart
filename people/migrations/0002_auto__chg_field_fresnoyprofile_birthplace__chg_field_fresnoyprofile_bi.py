...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FresnoyProfile.birthplace'
        db.alter_column(u'people_fresnoyprofile', 'birthplace', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'FresnoyProfile.birthdate'
        db.alter_column(u'people_fresnoyprofile', 'birthdate', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'FresnoyProfile.birthplace_country'
        db.alter_column(u'people_fresnoyprofile', 'birthplace_country', self.gf('django_countries.fields.CountryField')(max_length=2, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FresnoyProfile.birthplace'
        raise RuntimeError("Cannot reverse this migration. 'FresnoyProfile.birthplace' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FresnoyProfile.birthplace'
        db.alter_column(u'people_fresnoyprofile', 'birthplace', self.gf('django.db.models.fields.CharField')(max_length=255))

        # User chose to not deal with backwards NULL issues for 'FresnoyProfile.birthdate'
        raise RuntimeError("Cannot reverse this migration. 'FresnoyProfile.birthdate' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FresnoyProfile.birthdate'
        db.alter_column(u'people_fresnoyprofile', 'birthdate', self.gf('django.db.models.fields.DateField')())

        # User chose to not deal with backwards NULL issues for 'FresnoyProfile.birthplace_country'
        raise RuntimeError("Cannot reverse this migration. 'FresnoyProfile.birthplace_country' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FresnoyProfile.birthplace_country'
        db.alter_column(u'people_fresnoyprofile', 'birthplace_country', self.gf('django_countries.fields.CountryField')(max_length=2))
